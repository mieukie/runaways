...
new CircleType(document.getElementById('aluraC'))
  .radius(250);

new CircleType(document.getElementById('aliceC'))
.radius(250);

new CircleType(document.getElementById('marsC'))
.radius(250);

new CircleType(document.getElementById('selthyC'))
  .radius(250);

new CircleType(document.getElementById('salvierC'))
.radius(250);

new CircleType(document.getElementById('paigeC'))
.radius(250);

new CircleType(document.getElementById('lanceC'))
  .radius(250);

new CircleType(document.getElementById('fanaC'))
.radius(250);

new CircleType(document.getElementById('penelopeC'))
.radius(250);

new CircleType(document.getElementById('darrakC'))
  .radius(250);

new CircleType(document.getElementById('kethC'))
.radius(250);

new CircleType(document.getElementById('keithC'))
.radius(250);