...
var aluraC = new CircleType(document.getElementById('aluraC')).radius(x);
var aliceC = new CircleType(document.getElementById('aliceC')).radius(x);
var marsC = new CircleType(document.getElementById('marsC')).radius(x);
var selthyC = new CircleType(document.getElementById('selthyC')).radius(x);
var salvierC = new CircleType(document.getElementById('salvierC')).radius(x);
var paigeC = new CircleType(document.getElementById('paigeC')).radius(x);
var lanceC = new CircleType(document.getElementById('lanceC')).radius(x);
var fanaC = new CircleType(document.getElementById('fanaC')).radius(x);
var penelopeC = new CircleType(document.getElementById('penelopeC')).radius(x);
var darrakC = new CircleType(document.getElementById('darrakC')).radius(x);
var kethC = new CircleType(document.getElementById('kethC')).radius(x);
var keithC = new CircleType(document.getElementById('keithC')).radius(x)

window.onresize = getX;
